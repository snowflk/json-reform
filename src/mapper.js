...
function SchemaMapper(rules, opts = {}) {
...
SchemaMapper.prototype.compile = function () {
    let self = this;
    return function (obj) {
...
SchemaMapper.prototype.combineAllProps = function (modifiers, dest) {
...
SchemaMapper.prototype.promiseSwitch = function (field, val) {
    let retVal = {};
...
SchemaMapper.prototype.handleSingle = function (handler, attr, obj) {
    let field;
    let val;
...
SchemaMapper.prototype.handleMultiple = function (handlers, attr, obj) {
    let self = this;
    let promises = [];
...
SchemaMapper.prototype.transform = function (obj) {
